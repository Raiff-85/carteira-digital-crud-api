...
import br.com.emanoel_raiff.carteira_digital_crud_api.service.UsuarioService;
...
public class UsuarioController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Usuario> atualizar(@PathVariable Long id, @Valid @RequestBody Usuario dadosAtualizados) {
